...
class Item(db.Model):
    ...
    edificio = db.Column(db.Text, nullable=True)
    ficha = db.Column(db.Integer, nullable=True)
    marca = db.Column(db.Text, nullable=True)
    modelo = db.Column(db.Text, nullable=True)
    numserie = db.Column(db.Text, nullable=True)
    tiporefri = db.Column(db.Text, nullable=True)
